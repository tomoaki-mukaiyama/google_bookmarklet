...
nodes.forEach( node => {
    node.firstElementChild.addEventListener('focus', () => {
    ...
    if (node.querySelector(".GHDvEf")) {
        node.querySelector(".GHDvEf").setAttribute("tabindex","-1");
    };
});
...
if (document.querySelector('.Tg7LZd')) {
    document.querySelector('.Tg7LZd').style.display = "none";
};
    
if (document.querySelector('[jscontroller="unV4T"]')) {
    document.querySelector('[jscontroller="unV4T"]').style.display = "none";
};

if (document.querySelector('[jscontroller="qik19b"]')) {
    document.querySelector('[jscontroller="qik19b"]').style.display = "none";
};

if (document.querySelectorAll(".Q3DXx")[1]){
    document.querySelectorAll(".Q3DXx")[1].style.display ="none"
};

if (document.querySelector(".FyYA1e.IThcWe")){
    document.querySelector(".FyYA1e.IThcWe").style.display = "none";
};

if (document.querySelector(".jmjoTe")){
    document.querySelector(".jmjoTe").style.display = "none";
};
